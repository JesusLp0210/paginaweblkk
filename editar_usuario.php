...
$usuario=new Usuario();
$registro=$usuario->buscarId($idusuario);
                    ...
                    <form  action="actualizar_usuario.php" method="POST">
                      <input type="hidden" name="idusuario" value="<?=$idusuario ?>">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="Ingresa un nombre de usuario" name="nombre_usuario" value="<?=$fila['nombre_usuario']?>">
                        </div>
                        <div class="form-group mb-3">
                            <label class="font-weight-bold">Contraseña <span class="text-danger">*</span></label>
                            <input type="password" class="form-control" placeholder="Ingresa una contraseña" name="contraseña" value="<?=$fila['contraseña']?>" minlength="8" maxlength="20">
                        </div>
                          <div class="form-group mb-3">
